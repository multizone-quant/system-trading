...
if __name__ == "__main__":
    ...
    sheet = create_both_table(window, x, y, label_title, label_width, table_head)

    val = [312, 2.0, 1.2, 312, 1.0, 1.5, 1.0, 0.1, 10000]
    row = 0
    update_sheet(sheet, row, val, sign=[8]) # sign표시할 col
